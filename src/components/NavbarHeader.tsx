...
export const NavbarHeader = () => {
  ...
  return (
    <Navbar sticky="top" className="bg-body-tertiary">
      <Container>
        <Navbar.Brand href="/">{t("NavbarBrand.text")}</Navbar.Brand>
        <Nav className="me-auto">
          <Nav.Item>
            <Nav.Link href="https://linkedin.com/in/aiv/" target="_blank">
              <AiFillLinkedin size={25} />
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link href="https://instagram.com/ikoldakov" target="_blank">
              <AiFillInstagram size={25} />
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link href="mailto:ivan@koldakov.com?Subject=[koldakov]-koldakov">
